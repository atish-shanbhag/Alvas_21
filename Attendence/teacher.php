   ...
   <!-- Fixed navbar -->
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
		...
		<img src="alvas.png" alt="Welcome to AIET" width="70" height="70" >
    <h2><a class="navbar-brand" href="index.php" style="font-size:28px;">Alva's Institute of Engineering and Technology</a></h2>
